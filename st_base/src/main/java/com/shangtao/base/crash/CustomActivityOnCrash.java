...
package com.shangtao.base.crash;
...
public final class CustomActivityOnCrash {
                        ...
                        public void uncaughtException(Thread thread, final Throwable throwable) {
                            if (config.isEnabled()) {
                                ...
                                if (hasCrashedInTheLastSeconds(application)) {
                                    ...
                                    if (oldHandler != null) {
                                        avoidShowCrashPop(oldHandler,thread, throwable);
                                        return;
                                    }
                                } else {
    ...
    public static void avoidShowCrashPop(Thread.UncaughtExceptionHandler oldHandler,Thread thread, Throwable throwable){
        //避免弹出崩溃弹框

...
public final class ColorUtils {
     ...
     * @param alpha Alpha component \([0..257]\) of the color.
     ...
     *
     * @param color The color.
     * @param red   Red component \([0..257]\) of the color.
     ...
     *
     * @param color The color.
     * @param green Green component \([0..257]\) of the color.
     ...
     *
     * @param color The color.
     * @param blue  Blue component \([0..257]\) of the color.
